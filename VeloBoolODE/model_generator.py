...
class GenerateModel:
    ...
    def getParameters(self):
        ...
        u_max = self.kineticParameterDefaults['mRNATranscription']/self.kineticParameterDefaults['mRNASplicing']
        x_max = u_max*(self.kineticParameterDefaults['mRNASplicing']/self.kineticParameterDefaults['mRNADegradation'])
        ...
        parameterNamePrefixAndDefaultsGenes = {
            ...
            # mRNA splicing rates
            'b_':self.kineticParameterDefaults['mRNASplicing']
    ...
    def generateModelDict(self):
        ...
        for i,row in self.df.iterrows():
            ...
            if currgene in self.proteinlist:
                ...
                Splicing = 'b_'+ currgene + '*u_' + currgene
                Degradation = 'l_x_'  + currgene + '*x_' + currgene
                self.varspecs['u_' + currgene] = Production + '-' + Splicing
                self.varspecs['x_' + currgene] = Splicing + '-' + Degradation
